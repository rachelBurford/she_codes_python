...
def output_overall_statistics(monthly_data):
    ...
    print(f" {format_text('Nests',((max_length) - (len('Nests'))))}{format_text((Nests),17)}")
    print(f" {format_text('Hatched Nests',((max_length) - (len('Nests'))))}{format_text((Hatched),17)}")
    print(f" {format_text('False Crawls',((max_length) - (len('Nests'))))}{format_text((Fal),17)}")
    print(f" {format_text('Hit Rocks',((max_length) - (len('Nests'))))}{format_text((Hit),17)}")
    print(f" {format_text('Nest Predation',((max_length) - (len('Nests'))))}{format_text((Pred),17)}")
...
def output_monthly_statistics(monthly_data):
    ...
    print(f" {format_text((actions[0]),11)}{format_text((actions[1]),8)}{format_text((actions[2]),16)}{format_text((actions[3]),15)}{format_text((actions[4]),12)}{format_text((actions[5]),17)}")
    print(f" {format_text('October',11)}{format_text((nest[0]),8)}{format_text((nest[1]),16)}{format_text((nest[2]),15)}{format_text((nest[3]),12)}{format_text((nest[4]),17)}")
    print(f" {format_text('November',11)}{format_text((best[0]),8)}{format_text((best[1]),16)}{format_text((best[2]),15)}{format_text((best[3]),12)}{format_text((best[4]),17)}")
    print(f" {format_text('December',11)}{format_text((west[0]),8)}{format_text((west[1]),16)}{format_text((west[2]),15)}{format_text((west[3]),12)}{format_text((west[4]),17)}")
    print(f" {format_text('January',11)}{format_text((lest[0]),8)}{format_text((lest[1]),16)}{format_text((lest[2]),15)}{format_text((lest[3]),12)}{format_text((lest[4]),17)}")
    print(f" {format_text('February',11)}{format_text((test[0]),8)}{format_text((test[1]),16)}{format_text((test[2]),15)}{format_text((test[3]),12)}{format_text((test[4]),17)}")
    print(f" {format_text('March',11)}{format_text((jest[0]),8)}{format_text((jest[1]),16)}{format_text((jest[2]),15)}{format_text((jest[3]),12)}{format_text((jest[4]),17)}")
...
def output_nests_per_month_graph(monthly_data):
    ...
    print(f" {format_text('October:',11)}{format_text((October),4)}{format_text((oct_chart),35)}")
    print(f" {format_text('November:',11)}{format_text((November),4)}{format_text((nov_chart),35)}")
    print(f" {format_text('December:',11)}{format_text((December),4)}{format_text((dec_chart),35)}")
    print(f" {format_text('January:',11)}{format_text((January),4)}{format_text((jan_chart),35)}")
    print(f" {format_text('February:',11)}{format_text((February),4)}{format_text((feb_chart),35)}")
    print(f" {format_text('March:',11)}{format_text((March),4)}{format_text((mar_chart),35)}")
